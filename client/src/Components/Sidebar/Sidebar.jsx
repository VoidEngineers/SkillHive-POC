...
const Sidebar = () => {
    ...
    return (
        <>
            <motion.div
                className='sidebar-container sticky top-0 h-[100vh] bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 shadow-sm z-10'
            ...
            >
                <div className='flex flex-col justify-between h-full py-6 px-6'>
                    ...
                    <div className='flex-1 overflow-y-auto hide-scrollbar'>
                        <nav className='space-y-2'>
                            {mainu.map((item) => (
                                ...
                                >
                                    <div className={`text-xl ${activeTab === item.title ? "text-blue-600 dark:text-blue-400" : "text-gray-600 dark:text-gray-300"}`}>
                                        {activeTab === item.title
                                            ? item.activeIcon
                                            : item.icon}
                                    </div>
                    ...
                    <div className='mt-4 relative'>
                        ...
                        >
                            <IoReorderThreeOutline className='text-xl text-gray-600 dark:text-gray-300' />
                            {!isSidebarCollapsed && (
                        ...
                        <AnimatePresence>
                            {showDropdown && (
                                <motion.div
                                    className='absolute bottom-16 left-0 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden z-30'
                                    initial='closed'
                                    animate='open'
                                    exit='closed'
                                ...
                                >
                                    <div className='py-1'>
                                        <motion.div
                                            ...
                                            className='flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer font-medium'
                                        >
                    ...
                    {!isSidebarCollapsed && user?.reqUser && (
                        <div className='mt-6 flex items-center p-3.5 rounded-xl cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800'>
                            <img
                                src={
                                    user.reqUser.image ||
